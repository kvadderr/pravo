...
declare const measurableLocalTest: (pathToScan: string, options: import("./types").IaCTestFlags, orgPublicId: string, iacOrgSettings: import("./types").IacOrgSettings, rulesOrigin: import("./types").RulesOrigin) => Promise<import("./types").TestReturnValue>;
